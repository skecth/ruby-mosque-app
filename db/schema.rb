...
ActiveRecord::Schema[7.0].define(version: 2023_03_22_070459) do
  ...
  create_table "ajks", force: :cascade do |t|
    t.string "email", default: "", null: false
    t.string "encrypted_password", default: "", null: false
    t.string "reset_password_token"
    t.datetime "reset_password_sent_at"
    ...
    t.datetime "updated_at", null: false
    t.string "username"
    t.index ["email"], name: "index_ajks_on_email", unique: true
    t.index ["reset_password_token"], name: "index_ajks_on_reset_password_token", unique: true
  end

  create_table "kariahs", force: :cascade do |t|
    t.string "email", default: "", null: false
    t.string "encrypted_password", default: "", null: false
    t.string "reset_password_token"
    t.datetime "reset_password_sent_at"
    ...
    t.string "phoneNo"
    t.string "address"
    t.index ["email"], name: "index_kariahs_on_email", unique: true
    t.index ["reset_password_token"], name: "index_kariahs_on_reset_password_token", unique: true
  end

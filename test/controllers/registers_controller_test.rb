...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference("Register.count") do
      post registers_url, params: { register: { registrationDate: @register.registrationDate, registrationTime: @register.registrationTime } }
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { registrationDate: @register.registrationDate, registrationTime: @register.registrationTime } }
